  ...
  document.getElementById('content').innerHTML = `
    ...
    <div class="settings-section">
      ...
      <div style="display:flex;flex-direction:column;gap:12px;">
        ...
        <div>
          <label style="font-size:11px;letter-spacing:0.05em;color:var(--text2);display:block;margin-bottom:6px;">
            Zugriffspasswort Wochenübersicht
          </label>
          <div style="display:flex;align-items:center;gap:8px;">
            ...
            <button type="button" id="saveWpPw" class="btn-primary"
              style="padding:8px 16px;flex-shrink:0;white-space:nowrap;">
              <i class="ti ti-device-floppy"></i> Speichern
            </button>
          </div>
          <div id="wpPwStatus" style="font-size:11px;margin-top:6px;min-height:16px;"></div>
        </div>
