    ...
    <div class="settings-section">
      ...
      <div class="form-grid">
        <div class="field">
          ...
          <div style="display:flex;align-items:center;gap:8px;">
            <input type="password" id="s_publicWeekPassword"
              placeholder="Passwort für externe Ansicht festlegen…"
        ...
        <div class="field" style="display:flex;align-items:flex-end;gap:8px;">
          ...
          <button class="btn-ghost" onclick="navigator.clipboard.writeText(location.origin + location.pathname.replace(/[^/]*$/, '') + 'wochenplan-public.html').then(() => showToast('Link kopiert!'))" style="white-space:nowrap;">
            <i class="ti ti-copy"></i> Link kopieren
          </button>
        </div>
      </div>
      <p style="font-size:11px;color:var(--text3);margin-top:10px;">
        <i class="ti ti-shield-lock" style="font-size:12px;vertical-align:-1px;"></i>
        Das Passwort wird verschlüsselt in Firestore gespeichert und nie im Klartext weitergegeben.
        Teile den Link + Passwort separat.
      </p>
    </div>
