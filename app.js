...
function kaRenderSocialMedia() {
  ...
  const kanalBlocks = KA_SOCIAL_CHANNELS.map(k => {
    const col      = KA_CHANNEL_COLORS[k] || { c:'var(--accent)', bg:'rgba(59,130,246,0.1)' };
    ...
    const msgCards = !checked ? '' : msgs.length === 0
      ? `<div style="padding:4px 16px 14px 50px;font-size:13px;color:var(--text3);">Noch keine Nachrichten für ${k}</div>`
      : msgs.map(msg => {
          ...
          const contactBtn = msg.status !== 'kontakt_angelegt'
            ...
            : `<span style="font-size:12px;color:var(--green);"><i class="ti ti-check"></i> Kontakt angelegt</span>`;
          return `
            <div style="margin:0 16px 8px 50px;background:var(--bg3);border:1px solid var(--border);
              ...
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px;flex-wrap:wrap;">
                <span style="font-weight:600;font-size:13px;color:var(--text);">${msg.absender || '(Unbekannt)'}</span>
              ...
              <div style="font-size:13px;color:var(--text2);line-height:1.6;margin-bottom:10px;
                background:var(--surface);border-left:3px solid ${col.c};padding:8px 12px;border-radius:0 8px 8px 0;">
                "${msg.text}"
              </div>
    ...
    return `
      <div style="background:var(--surface);border:1px solid ${checked ? col.c + '66' : 'var(--border)'};
        ...
        <label style="display:flex;align-items:center;gap:14px;padding:14px 16px;cursor:pointer;user-select:none;"
          ...
          <span style="font-size:15px;font-weight:600;color:var(--text);flex:1;">${k}</span>
          <i class="ti ${checked ? 'ti-chevron-up' : 'ti-chevron-down'}" style="font-size:16px;color:var(--text3);flex-shrink:0;"></i>
          ...
          ${msgs.length > 0 && neuCount === 0 ? `<span style="background:var(--bg3);color:var(--text3);border:1px solid var(--border);border-radius:20px;padding:2px 9px;font-size:12px;">${msgs.length}</span>` : ''}
        </label>
        ${msgCards}
