...
function openNotesOverlay() {
  ...
  menuBtn.title = 'Menü öffnen';
  menuBtn.style.cssText = 'position:absolute;top:0.75rem;left:1rem;z-index:10001;'
    + 'width:42px;height:42px;border-radius:10px;'
    + 'background:rgba(15,23,42,0.9);backdrop-filter:blur(8px);'
    + 'border:1.5px solid rgba(99,102,241,0.4);'
    + 'color:#818cf8;font-size:20px;cursor:pointer;'
    + 'display:flex;align-items:center;justify-content:center;'
    + 'transition:background .18s,color .18s;';
  menuBtn.onmouseover = function() { this.style.background='#6366f1'; this.style.color='#fff'; };
  menuBtn.onmouseout  = function() { this.style.background='rgba(15,23,42,0.9)'; this.style.color='#818cf8'; };
