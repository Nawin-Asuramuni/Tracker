...
const _origRenderSettings = window.renderSettings || renderSettings;
...
if (_pagesRef && _pagesRef.settings) {
  _pagesRef.settings.render = renderSettings;
}
  ...
  requestAnimationFrame(() => {
    ...
    catRow.innerHTML = `
      ...
      <span class="detail-val" style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
        ${categoryBadge(c.contactCategory) || '<span style="color:var(--text3);font-size:13px;">—</span>'}
