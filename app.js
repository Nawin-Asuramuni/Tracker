...
function openNotesOverlay() {
  ...
  // Sidebar zuerst mit ihrer eigenen Animation schließen ...
  closeSidebar();

  // ... und das Notizen-Panel kurz danach von rechts einschweben lassen,
  // damit die Schließ-Animation des Menüs sichtbar bleibt.
  setTimeout(() => {
