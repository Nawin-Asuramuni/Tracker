...
function renderCalendar() {
  ...
  document.getElementById('content').innerHTML = `
    ...
    <div style="display:flex;gap:6px;margin-bottom:16px;flex-wrap:wrap;">
      ${[-1,0,1,2].map(w => {
        ...
        return `<button onclick="calWeekOffset=${w};renderCalendar()"
  ...
  document.getElementById('prevWeek').addEventListener('click', () => { calWeekOffset--; renderCalendar(); });
  document.getElementById('nextWeek').addEventListener('click', () => { calWeekOffset++; renderCalendar(); });
  document.getElementById('goToday')?.addEventListener('click', () => { calWeekOffset = 0; renderCalendar(); });
}
    ...
    <div class="settings-section">
      ...
      <div class="form-grid">
        ...
        <div class="field full"><label>E-Mail Signatur <span style="font-weight:400;color:var(--text3);font-size:11px;">(optional – nur wenn kein Outlook/Mailclient)</span></label>
          <textarea id="s_emailSig" rows="2" placeholder="Mit freundlichen Grüßen,&#10;Max Mustermann">${s.emailSig||''}</textarea>
